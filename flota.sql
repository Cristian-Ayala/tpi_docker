CREATE DATABASE  IF NOT EXISTS `flota` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `flota`;
-- MySQL dump 10.16  Distrib 10.3.8-MariaDB, for debian-linux-gnu (x86_64)
--
-- Host: localhost    Database: flota
-- ------------------------------------------------------
...
INSERT INTO `marca` VALUES (1,'Toyota','Marca Toyota',''),(2,'Nissan','Marca Nissan',''),(3,'Honda','Marca Honda',''),(4,'Chevrolet','Marca Chevrolet',''),(5,'Mazda','Marca Mazda',''),(6,'Ford','Marca Ford','');
...
-- Dump completed on 2018-09-05 22:50:10
